...
// See also gMPU-9250 Register Map and Descriptions, Revision 4.0,
// RM-gMPU-9250A-00, Rev. 1.4, 9/9/2013 for registers not listed in above
...
class MPU9250
{
  ...
  private:
    ...
    void writeByteIMU(uint8_t, uint8_t);
    void writeByteMAG(uint8_t, uint8_t);

    uint8_t readByteIMU(uint8_t);
    uint8_t readByteMAG(uint8_t);

    void readBytesIMU(uint8_t, uint8_t, uint8_t *);
    void readBytesMAG(uint8_t, uint8_t, uint8_t *);
